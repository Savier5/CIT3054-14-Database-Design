...
ORD_LINE_QTY       DECIMAL(10,0),
ORD_LINE_UNIT_COST DECIMAL(8,2),
ORD_LINE_TOT       DECIMAL(12,2));
...
ORD_SHIP_COST      DECIMAL(10,2),
ORD_TOT_COST       DECIMAL(10,2),
USER_ID            INTEGER,
ORD_DATE_REC       DATE,
...
insert into ORDERS values (939, '2017-11-11', NULL , NULL , 'CART', 8801, '(4) Remanuf toners', 0, 215.8, 5, '2017-11-14', 'REC', 'LAB');
insert into ORDERS values (940, '2017-12-25', NULL, '245650', 'CART', '210559', '(1) HyperCam software', 0, 30, 5, NULL, 'OPEN', 'LAB');
insert into ORDERS values (941, '2017-12-31', NULL, '24650', 'DELL', '171114564', '(2) 32MB SIMM and DIMM for Dell @ Lab', 0, 110.4, 16, '2017-01-03', 'REC', 'LAB');
insert into ORDERS values (942, '2018-01-01', NULL, NULL, 'LSREX', '8893', '(5) Remanuf', 0, 269.75, 17, '2018-01-04', 'REC', 'LAB');
insert into ORDERS values (943, '2018-01-05', NULL, 245650, 'CART', 'C#638708', '(2) 32MB EDO SIMMS for Vektron NT test', 7.35, 79.33, 10, NULL, 'OPEN', 'LAB');
insert into ORDERS values (944, '2018-01-10', NULL, NULL , 'DELL', '8908', '(1) HP4 new drum, (2) HP4 toner refill, (4) HP4 toner+drum', 0, 443.5, 5, '2018-01-11', 'REC', 'LAB');
insert into ORDERS values (945, '2018-01-10', NULL , 245650, 'CART',NULL , '(10) 32MB EDO RAM SIMMS', 12, 372, 6, NULL, 'OPEN', 'LAB');
insert into ORDERS values (946, '2018-01-12', NULL, NULL, 'COEX', '149363', '(10) 8 1/2 x 11 Laser Paper Boxes', 0, 193.8, 17, '2018-01-13', 'REC', 'LAB');
insert into ORDERS values (947, '2018-01-20', NULL, NULL, 'DELL', '8842', '(4) Remanuf Toners', 0, 215.8, 7, '2018-01-22', 'REC', 'LAB');
insert into ORDERS values (950, '2018-01-21', NULL, NULL, 'LSREX', '8856', '(2) Toner w/drum', 0, 167.8, 5, '2018-01-22', 'REC', 'LAB');
insert into ORDERS values (951, '2018-01-24', NULL, NULL, 'CART', '8993', '(7) Remanf toners, (1) Toner w/ drum replace', 0, 431.6, 13, '2018-01-26', 'REC', 'LAB');
